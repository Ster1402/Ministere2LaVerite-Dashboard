<x-table-layout>
    <x-slot name="header">
        ...
        <h4>
            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#reportModal">
                <i class="fas fa-print"></i> Exporter la liste des ressources
            </a>
        </h4>
    </x-slot>
    ...
    <x-slot name="body">
        ...
        <x-report-modal model-name="resources" title="Exporter la liste des ressources" />
                ...
                <tbody>
                    @foreach ($data as $resource)
                        <tr>
                            ...
                            <td>
                                <a href="#edit-resource-{{ $resource->id }}" data-toggle="modal"
                                    class="btn btn-warning">
                                    <i class="fas fa-edit"></i>
                                    Éditer
                                </a>
                                <!-- Button to trigger modal -->
                                <a class="btn btn-danger" href="#delete-resource-{{ $resource->id }}"
                                    data-toggle="modal">
                            ...
                            <x-modal id="grantRessourceTo-{{ $resource->id }}"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <input id="quantity" name="quantity" min="0" type="number"
                                        value="{{ old('quantity') }}" class="form-control" style="width:300px" />
                                </div>
                            </x-modal>
                        </tr>
                    @endforeach
