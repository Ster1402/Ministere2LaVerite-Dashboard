<x-table-layout>
    <x-slot name="header">
        ...
        <h4>
            <a href="#print-events" data-toggle="modal" class="btn btn-info">
                <i class="fas fa-print"></i> Télécharger la liste des Évènements
            </a>
        </h4>
    </x-slot>
    ...
    <x-slot name="body">
        ...
        <x-modal id="print-events" action="{{ route('report.events')}}">
            <h2>Voulez-vous télécharger la liste des évènements ?</h2>
        </x-modal>
