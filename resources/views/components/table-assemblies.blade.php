<x-table-layout>
    <x-slot name="header">
        ...
        <h4>
            <a href="#print-assemblies" data-toggle="modal" class="btn btn-info">
                <i class="fas fa-print"></i> Télécharger la liste des Assemblées
            </a>
        </h4>
    </x-slot>
    ...
    <x-slot name="body">
        ...
        <x-modal id="print-assemblies" action="{{ route('report.assemblies')}}">
            <h2>Voulez-vous télécharger la liste des assemblées ?</h2>
        </x-modal>
            ...
            <table class="table table-striped"
                ...
                @foreach($data as $assembly)
                    <tr>
                        ...
                        <td>
                            <a href="#edit-assembly-{{ $assembly->id }}"
                               data-toggle="modal"
                            ...
                            <x-modal-delete action="{{ route('assemblies.destroy', ['assembly' => $assembly->id]) }}"
