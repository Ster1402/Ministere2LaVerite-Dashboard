        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Éditez votre post</h4>
                </div>
                <form method="POST" action="{{ route('messages.update', ['message' => $message->id]) }}" class="card-body">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input name="subject" required value="{{ $message->subject }}" id="subject" type="text"
                                   class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select id="category" name="category" class="form-control selectric">
                                ...
                                @foreach($categories as $category)
                                    <option
                                        {{ $message->category == $category ? 'selected' : '' }}
                    ...
                    <div class="form-group row mb-4" id="assembly-select-group-user" style="display: {{ $message->receiver == null ? 'none' : 'flex' }};">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select id="receiver" class="form-control selectric" name="receiver">
                                @foreach($users as $user)
                                    <option
                                        {{ $message->receiver?->id === $user->id ? 'selected' : '' }}
                    ...
                    <div class="form-group row mb-4" id="assembly-select-group" style="display: {{ $message->receiver == null ? 'flex' : 'none' }};">
                        ...
                        <div class="col-sm-12 col-md-7 input-group">
                            ...
                            <select id="assemblies" name="assemblies[]" class="form-control select2" multiple=""
                                ...
                                @foreach($assemblies as $assembly)
                                    <option
                                        {{ $message->assemblies?->contains('id', $assembly->id) ? 'selected' : '' }}
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <label class="custom-switch mt-2">
                                <input
                                    {{ $message->receiver == null ? 'checked' : '' }}
                                    type="checkbox" name="custom-switch-checkbox" id="assemblycheck"
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <textarea required name="content" id="content"
                                      class="summernote-simple">{{ $message->content }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input id="tags" type="text" value="{{ $message->tags }}" name="tags" class="form-control inputtags">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
