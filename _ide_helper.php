...
namespace Jimmyjs\ReportGenerator\Facades {
     ...
     */        class PdfReportFacade {
         ...
         *
         * @static 
         */        public static function store($filePath)
        {
                        /** @var \Jimmyjs\ReportGenerator\ReportMedia\PdfReport $instance */
                        return $instance->store($filePath);
        }
                    /**
         * 
         *
     ...
     */        class ExcelReportFacade {
         ...
         *
         * @static 
         */        public static function store($filePath, $customDisk = null)
        {
                        /** @var \Jimmyjs\ReportGenerator\ReportMedia\ExcelReport $instance */
                        return $instance->store($filePath, $customDisk);
        }
                    /**
         * 
         *
     ...
     */        class CSVReportFacade {
         ...
         *
         * @static 
         */        public static function download($filename, $save = false)
        {
                        /** @var \Jimmyjs\ReportGenerator\ReportMedia\CSVReport $instance */
                        return $instance->download($filename, $save);
        }
                    /**
         * 
         *
